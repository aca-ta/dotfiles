    ...
    },
    {
        ...
        config = function()
            require("which-key").add({
                ...
                { "<leader>tf", "<cmd>ToggleTerm direction=float<cr>",      desc = "ToggleTerm direction float" },
                { "<leader>th", "<cmd>ToggleTerm direction=horizontal<cr>", desc = "ToggleTerm direction horizontal" },
